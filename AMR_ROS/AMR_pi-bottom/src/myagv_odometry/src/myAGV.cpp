...
//
//const double ODOM_LINEAR_SCALE_FACTOR = 1.25;
//const double ODOM_ANGULAR_SCALE_FACTOR = 1.0;//0.88017
//
//boost::asio::io_service iosev;
...
//    lastTime = ros::Time::now();
//
//    imu_sub = n.subscribe("/imu/data", 10, &MyAGV::imuCallback, this);
...
//
//    vx = (static_cast<double>(buf[index]) - 128.0) * 0.01;
//    vx *= ODOM_LINEAR_SCALE_FACTOR;
//    vy = (static_cast<double>(buf[index + 1]) - 128.0) * 0.01;
//    vtheta = (static_cast<double>(buf[index + 2]) - 128.0) * 0.01;
//    vtheta *= ODOM_ANGULAR_SCALE_FACTOR;
//
